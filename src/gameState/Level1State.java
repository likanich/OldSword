...
public class Level1State extends GameState{
	...
	public void keyPressed(int k) {
		...
		if (k == KeyEvent.VK_LEFT) player.setFiring(1);
		if (k == KeyEvent.VK_RIGHT) player.setFiring(2);
		if (k == KeyEvent.VK_UP) player.setFiring(3);
		if (k == KeyEvent.VK_DOWN) player.setFiring(4);
